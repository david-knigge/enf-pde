...
___
## Overview
This is the reproducibility repo for the paper "Space-Time Continuous PDE Forecasting using Equivariant Neural Fields". All experiments
in the paper should be reproducible using the code in this repository. Data for the experiments is generated by using solvers provided by [Dedalus](https://dedalus-project.readthedocs.io/en/latest/index.html) and [Py-PDE](https://py-pde.readthedocs.io/en/stable/index.html), except for the Navier-Stokes equations .
___
## Requirements
